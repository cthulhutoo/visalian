...
Sometimes we get a chance to go on site early and shoot photos and video.  You can do this so many ways.  I know some people send huge teams with pallets of gear and huge invoices. With the improvments in hardware and software amazing results can be had at a fraction of the cost.  With so many socail media platforms to fill with new images, this approach is hard to beat.
